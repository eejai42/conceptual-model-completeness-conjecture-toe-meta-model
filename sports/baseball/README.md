...
- **useReplayReview**  
  *Description:* Whether official replay review is permitted in this rule set.  
...
- **mustEndDueToMercyRule**  
  ...
  *Formula:* `IF (this.inningId.gameId.isMercyRuleTriggered = true) THEN true ELSE false`
- **stealingAllowed**  
